...
// `clients` array (previously a bare module-level global in the monolith) and the
// PORT/SEED/SEED_ACTIONS-adjacent seed data that constructs it.
//
// ASSUMPTIONS about other modules' exports (unverified — sibling files may not exist
// yet at the time of writing; flagged for the integration pass):
//   - profiles-repo.js exports: getActiveUser, getVisibleClientIds, loadUsers
//   - actions-repo.js exports: getActions, setActions, getActionsKey, seedActions,
//     mergeSeedActions, LS_ACTIONS
//   - notes-repo.js exports: loadNotes
//   - gist-sync.js exports: scheduleGistSave, pushToSupabase
//   - zendesk-sync.js exports: ZD_EMAIL_KEY, ZD_TOKEN_KEY, syncZendesk
//   - renderKPIs/renderTable/renderFicha are DOM-render functions not assigned to any
//     file in this agent's scope. Guessed import path '../ui/render.js' as a
//     placeholder — reconcile once the real ui/*.js module(s) exist.
...
import { ZD_EMAIL_KEY, ZD_TOKEN_KEY, syncZendesk } from './zendesk-sync.js';
import { renderKPIs } from '../ui/kpis.js';
import { renderTable } from '../ui/overview.js';
import { renderFicha } from '../ui/ficha.js';
// setUpdateLabel is defined locally below (trivial 2-line DOM text update tightly
// coupled to `clients.length` + SEED_VERSION — kept in this file rather than
// speculatively assigned to a ui/*.js file that doesn't exist yet in any agent's scope).
...
// MRR seed estimates (USD/month), extracted verbatim from index.html:2162-2235.
...
export const SEED = [
  {nombre:"FASHIONS PARK",                               tickets:0, bugs:0, ticketsPendientes:0, ticketDetalle:null, causaRaiz:null,                                                                                                                                                                                                                               gmv:12918685400,  upPlan:null, qtUp:null, nps:null,   lastContact:"2026-04-15", centry:false},
  {nombre:"COBOE S/A - BOTIGA",                          tickets:1, bugs:0, ticketsPendientes:1, ticketDetalle:"#33612 - RCA Inconsistencia precio/moneda en integración Botiga (01-jul)",                                                              causaRaiz:"Thread #29517/#24210/#22594 — inconsistencia precio/moneda AnyMarket↔Botiga. RCA en curso.",                                gmv:247659908,    upPlan:null, qtUp:null, nps:100,   lastContact:"2026-07-01", centry:false},
  {nombre:"COBOE S/A - FARMASHOP",                       tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:811908825,    upPlan:null, qtUp:null, nps:null,  lastContact:"2026-06-23", centry:false},
  ...
  {nombre:"DIVINO S.A",                                  tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:778623000,    upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-26", centry:false},
  ...
  {nombre:"FORUS COLOMBIA",                              tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:"2026-05-29", centry:true},
  {nombre:"FORUS SA",                                    tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:"2026-07-01", centry:true},
  {nombre:"GINO",                                        tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:"2026-07-03", centry:true},
  ...
  {nombre:"LOI CHILE",                                   tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:18226158700,  upPlan:null, qtUp:null, nps:100,   lastContact:"2026-06-30", centry:false},
  {nombre:"LOUNGE S/A",                                  tickets:0, bugs:0, ticketsPendientes:0, ticketDetalle:null,                                                                                                                                   causaRaiz:null,                                                                                                       gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-10", centry:true},
  ...
  {nombre:"MAUI AND SONS",                               tickets:2, bugs:0, ticketsPendientes:2, ticketDetalle:"#33437 - Migración Prosurf a cuenta Maui (01-jul) | #32882 - Carga docs tributarios sellers (30-jun)",                                        causaRaiz:"Migración Prosurf→Maui pendiente config auth ML + SKU + precios. Paralelo: carga docs tributarios sellers sin cerrar.", gmv:74659220800,  upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-26", centry:false},
  ...
  {nombre:"POINTBREAK",                                  tickets:0, bugs:0, ticketsPendientes:0, ticketDetalle:null,                                                                                                                                   causaRaiz:null,                                                                                                       gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:"2026-04-08", centry:false},
  ...
  {nombre:"BEITGROUP PE",                                tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:1711666,      upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-26", centry:false},
  {nombre:"RIP CURL",                                    tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:null,         upPlan:null, qtUp:null, nps:null,   lastContact:null,         centry:false},
  ...
  {nombre:"PROSURF",                                     tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:11063256000,  upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-26", centry:false},
  ...
  {nombre:"BEL STAR S/A - BELCORP Peru",                 tickets:0, bugs:0, ticketsPendientes:0,                                                                                                                                                               gmv:1736582,      upPlan:null, qtUp:null, nps:null,   lastContact:"2026-06-26", centry:false},
...
export const SEED_MARKETPLACES = {
...
export function rebuildClients(saved) {
...
// Accessors (module-owned mutable state — see src/services/clients-repo.js header note)
export function getClients() { return clients; }
export function setClients(newArr) { clients = newArr; }

// Reset the double-load guard. The original monolith did this via a bare
// `_appLoaded = false;` reassignment (shared global) before calling load()
// again — e.g. on profile switch/logout (services/auth.js) and after a
// successful cloud sync (services/gist-sync.js). Now that `_appLoaded` is
// private module state, callers must go through this exported reset hook.
export function resetLoadGuard() { _appLoaded = false; }

// NOTE: getDeletedSeedTitles()/markSeedAsDeleted() (index.html ~2683-2691) operate on
// LS_DELETED_SEEDS and are used exclusively by actions-repo.js's mergeSeedActions()/
// deleteCurrentAction() — defined there, not duplicated here. This clients-repo.js only
// owns the LS_DELETED_SEEDS *constant* (co-located with LS_DATA in source) and exports it
// for actions-repo.js to import.
...
export function load() {
  ...
  loadNotes();
  populateSelects();
  // Auto-sync Zendesk si hay credenciales configuradas
  if (localStorage.getItem(ZD_EMAIL_KEY) && localStorage.getItem(ZD_TOKEN_KEY)) {
    setTimeout(function() { syncZendesk(false); }, 1500);
  }
}
...
// setUpdateLabel: trivial DOM text update tightly coupled to `clients.length` +
// SEED_VERSION — kept in this file (see header note) rather than a ui/*.js file.
export function setUpdateLabel(dt) {
  document.getElementById('sidebarFooter').textContent = 'Última act.: ' + (dt||'—');
  document.getElementById('pageSubtitle').textContent = clients.length + ' clientes · datos al ' + (dt||'—');
}
