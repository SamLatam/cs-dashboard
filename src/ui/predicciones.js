// Extracted verbatim from index.html (lines ~6265-6468, "renderPredicciones")
//
// The task brief estimated this function ran to ~6879, but brace-matching the
// actual source shows renderPredicciones closes at line 6468 — immediately
// after that, index.html:6470 starts a new "── FAQ CS & ANYMARKET & ANYTOOLS"
// section with `const FAQ_DATA = [...]`, which belongs to src/ui/faq.js, not
// here. calcChurnRisk/calcTicketImpact/calcUpsell (index.html:6227-6264) are
// pure calc functions extracted by another agent into
// ../domain/predictions.js — imported below rather than redefined.
//
