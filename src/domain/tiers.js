// Extracted verbatim from index.html (lines 6936-6976)
// ── PORTFOLIO A — ACELERACIÓN ──────────────────────────────────────────────
// These back both "Portafolio Estratégico" (renderPortfolioA) and the
// "quick wins" check inside renderOverview/renderCapacitacion — export cleanly
// for reuse by those (other agents' UI) files.
...
export { PORTFOLIO_GAP, GRUPO_ESTRATEGICO };
